...
page](https://github.com/pingme998/rclone).
...
rclone currently uses [GitHub Actions](https://github.com/pingme998/rclone/actions) to build and test the project, which should be automatically available for your fork too from the `Actions` tab in your repository.
...
project root:
    ...
    go install github.com/pingme998/rclone/fstest/test_all
...
[Go reference](https://godoc.org/github.com/pingme998/rclone/lib/plugin)
